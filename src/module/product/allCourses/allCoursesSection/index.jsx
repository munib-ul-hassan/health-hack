                ...
                <Slider {...settings} className="all_books_slider">
                  <div className="p-4">
                    <div className="w-full cursor-pointer flex items-center flex-col gap-4 p-5 border-[1px] border-solid border-[#E0E0E0] rounded-2xl bg-white relative">
                      ...
                      <div className="pt-40 flex flex-col items-center justify-center gap-4 px-10">
                        ...
                        <p className="font-light text-base text-center py-4">
                          Experience razor-sharp focus and mental clarity –
                          empower yourself to accomplish more, think faster...
                        </p>
                      </div>
                  ...
                  <div className="p-4">
                    <div className="w-full cursor-pointer flex items-center flex-col gap-4 p-5 border-[1px] border-solid border-[#E0E0E0] rounded-2xl bg-white relative">
                      <div className=" absolute -top-20">
                        ...
                        <img src={course_IMG} alt="course_IMG" className="w-full" />
