...
import banner_img_right from "../../../../assets/banner_img_right.svg";



export const AllCoursesBanner = () => {
  return (
    <div>
         <div className="w-full">
            <div className="w-full relative mb-4">
              ...
              <div className="w-full absolute top-10 text-white">
                  <div className="w-full my-24 flex justify-between gap-5 items-start">
                    <div className="flex flex-col gap-4 w-3/4 pl-20 pt-20">
                    ...
                    <div className="w-full flex justify-end items-end relative">
                      <img
                        src={banner_img_right}
                        alt="banner_img_right"
