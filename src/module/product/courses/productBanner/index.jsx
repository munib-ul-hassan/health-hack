...
export const ProductBanner = () => {
  return (
    <div className="w-full relative my-4">
      <img src={product_bg} alt="product_bg" className="w-full h-full" />
      <div className="w-full absolute top-10 text-white">
        <div className="w-mainWidth mx-auto flex gap-8 justify-between items-center relative">
          <div className="w-2/5">
            <div className="absolute -top-[83px]">
          ...
          <div className="w-3/5 flex justify-start items-start flex-col gap-4 mt-20">
            ...
            <div>
              ...
              <div className="text-lg font-medium flex items-center justify-center gap-3 uppercase text-[#20ea6d] border-[#20ea6d] border-2 px-10 rounded-2xl py-4 my-4 w-72">
