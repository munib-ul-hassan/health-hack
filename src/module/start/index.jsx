...
import main_start from "../../assets/img_start_main.svg";
  ...
  return (
    <>
      ...
      <div className="w-full my-0">
        <div className="w-[450px] mx-auto bg-white rounded-none pb-[2px] max-[450px]:!w-full">
          <div className="relative">
            <div className="relative">
            <img src={main_start} alt="main_start" className="w-full absolute -top-10 max-[450px]:top-8" />
            </div>
            {/* <div className="flex justify-center items-center absolute -top-4 left-[28%] max-[450px]:left-28  max-[430px]:left-[120px]  max-[450px]:top-0 max-[390px]:left-[95px]  max-[390px]:top-2 max-[376px]:left-[95px]  max-[350px]:top-5 max-[360px]:left-[80px]">
              <img src={kam} alt="kam" className="max-[450px]:w-11/12 max-[380px]:w-4/5" />
            </div> */}
            <div className="content_Section pt-64 max-[435px]:pt-60 max-[390px]:pt-52 max-[360px]:pt-44">
              <div>
                <h1 className="text-3xl text-center font-bold">
                  Health Hack Hub
                </h1>
              </div>
              <div className="social_media_icons flex justify-center items-center gap-3 pt-4 max-[450px]:gap-2">
                <div>
